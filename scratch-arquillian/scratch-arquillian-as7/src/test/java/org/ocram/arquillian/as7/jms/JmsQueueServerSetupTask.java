package org.ocram.arquillian.as7.jms;
...
public class JmsQueueServerSetupTask implements ServerSetupTask {
    ...
    private String []  queueNames = { MessageEchoBean.QUEUE_NAME };
...
//        op.get(ClientConstants.OP).set(ClientConstants.REMOVE_OPERATION);
    ...
    private void createTemporaryDynamicJMSQueue(String queueName) { 
        try {
            ...
            logger.error("Unable to create dynamic JMS queue via " + JmsQueueServerSetupTask.class.getSimpleName(), e);
        }
    }
}
